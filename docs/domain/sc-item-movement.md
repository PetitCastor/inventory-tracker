...
**Game updates move items without logging it.** Build 12519617 was first played on 2026-08-27. In that session, 13 items the ledger had at Lorville, at Levski or equipped were all moved out of Area18, the station where the player spawned after the update. No line records the server relocating them. Within one build, every named move out of a place agreed with the ledger, up to 21 days later. Treat a change of build, not age, as what makes a placement stale. The tracker moves belongings stored at a station or on the player to the first station the player arrives at in the new build. The [reliability study](../reliability/README.md) checks, per update, whether they were found there.
